...
import Ports.Ports exposing (DatePickerMsg, buildDatePicker, handleDateChange, getCurrentDate)
import Rest
    exposing
        ( getUser
        , getLiftsCall
...
import Types exposing (Model, Msg(..), Page(..), Cardio(..), SetFormMsg(..), Data(..))
import User.View as User
import Workout.View as Workout
import AddWorkout.View exposing (addModal)
import Bootstrap.Modal as Modal
import Bootstrap.Dropdown as Drop
import Bootstrap.Button as Button
import FontAwesome.Web as Icon
import Shared.Generated exposing (encodeWorkout, encodeExercise, encodeLift, encodeRun, encodeSet, encodeUser)
import Shared.Helper exposing (getRunStats, getTotalTimeWorkout, getGraphDataRunDistance, getGraphDataRunMile, getGraphDataRunSpeed)
import Login
import Signup
...
-- <|
--     List.append
--         (List.map buildDatePicker <|
--             List.map (\( _, y ) -> DatePickerMsg y "1-1-2000 TO 1-23-2001") <|
--                 Dict.toList initModel.dateNames
--         )
-- SUBSCRIPTIONS
