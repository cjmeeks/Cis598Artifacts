...
import AddWorkout.View exposing (runView, exerciseView)
    ...
    Card.config [ Card.attrs [ class "run-card" ] ]
        |> Card.headerH1 []
            [ div [ class "ex-header row" ]
                ...
                , if bool then
                    div [ class "col-11" ] [ Button.button [ Button.onClick (SaveUserWorkout wk), Button.attrs [ class "fav-wk-button" ] ] [ text "Favorite" ] ]
                  else
                    span [] []
                ]
            ]
